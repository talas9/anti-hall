...
- **Thinking:** MAXIMUM. Extended thinking ON, effort `xhigh`.
...
```bash
codex exec --model gpt-5-codex --config model_reasoning_effort=high \
...
Set the highest reasoning-effort the installed Codex supports.)

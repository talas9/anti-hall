...
Run `anti-hall-deadly-loop` against the plan before code for L work. Debate/validation uses the **frontier** category. Convergence (LOCK) requires **zero NEW P0 and P1 findings** — a single confirmed P1 blocks LOCK the same as a P0.
...
- planning/validation/debate: **frontier**
- mechanical command execution: **fast**

...
> S4-measured (~5× smaller than verbose prose, lossless) — all in
...
|---|---|---|
| **Version** | `0.26.0` | `plugin.json` `version` — the single authority. Marketplace entry carries NO `version` (avoids the silent-precedence trap). |

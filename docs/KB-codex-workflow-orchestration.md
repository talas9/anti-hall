...
| Model distribution | Codex subagent docs recommend choosing model/reasoning by task, with `gpt-5.5`, `gpt-5.4`, `gpt-5.4-mini`, and `gpt-5.3-codex-spark`. | Anti-hall model policy aligns: `gpt-5.5` for debate/review, `gpt-5.4` implementation, mini/spark for lookup/mechanical work. |

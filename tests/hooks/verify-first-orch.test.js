...
const ORCHESTRATION_LABELS = [
  ...
  ['is the DEFAULT for every user-facing report', 'rule K: scannable style is the DEFAULT, not occasional'],
  ['sliding back to bare plain text over a long session is DRIFT', 'rule K: plain-text regression is drift to correct'],
  ['never decoration', 'rule K: emoji is signal, never decoration'],
